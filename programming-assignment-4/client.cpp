...
//replace all instances of fifo request channel instances with TCPRequestChannel
// change to the appropriate constrcutor

//getopt, add a and r collect values into vars
...
void file_thread_function(int m, string filename, TCPRequestChannel *chan, BoundedBuffer *reqBuf)
{
...
void worker_thread_function(int m, int p, string filename, TCPRequestChannel *chan, BoundedBuffer *reqBuf, BoundedBuffer *popBuf)
{
...
int main(int argc, char *argv[])
{
    ...
    string a = "127.0.0.1"; //IP adddress
    string r = "8080";   //port #
